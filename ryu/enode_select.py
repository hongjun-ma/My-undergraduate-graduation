...
class enode_select(app_manager.RyuApp):
    ...
    def selecting(self):
        ...
        # Import a MAB algorithm. change UCB to any of algorithms defined in mab.py
        # Read mab.py for details of each algorithm
        mab_model = UCB(action_list, len(action_list),0.1)
        ...
        for i in range(len(action_list)):
            ...
            #delay calculating
            delays = []
            for j in range(5): #delay is calculated 10 times in a session
        ...
        with open('Aarnet-UCB-reward.txt', 'a') as f:
            f.write('----------------------Aarnet-UCB-reward------------------------ \n')
        round = 1
        ...
        while True:
            ...
            #Each round the mab_model is triggered to choose a egress points 5 times
